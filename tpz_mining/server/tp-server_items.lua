...
TPZInv.registerUsableItem(Config.PickaxeItem, "tpz_mining", function(data)
    ...
    TriggerClientEvent('tpz_mining:onPickaxeItemUse', _source, data.itemId, data.durability )
